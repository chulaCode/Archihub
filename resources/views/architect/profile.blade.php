					...
					<div class="single-post row">
                       <div class="col-md-3 meta-details" style="margin-top:-15px">
                           <div class="wrapper">
                            ...
                            <p class="date col-lg-12 col-md-12 col-6"><a href="{{route('architect.index')}}">My feed</a> <span class="lnr lnr-screen"></span></p>
								<p class="user-name col-lg-12 col-md-12 col-6"><a href="{{route('architect.profile')}}">My profile</a> <span class="lnr lnr-user"></span></p>
