      ...
      <div class="col-lg-3 col-sm-11 sidebar-widgets">
			<div class="widget-wrap">	
                ...
                <div class=" company-logo blank-logo text-center text-md-center pl-lg-0 mt-4">
                    ...
                    <a href="{{route('architect.profile')}}"> <h4 class="popular-title">My Profile</h4>    </a>
                    </div>	
              
                

                <div class="single-sidebar-widget" style="margin-top:-10px">
                  <a href="{{route('architect.index')}}"><h4 class="popular-title ml-1 mb-3 text*white">My Categories</h4> </a>
                    <form class="" action="{{route('architect.urban')}}" method="get"> @csrf
                        <input type="hidden" name="urban" value="urban">
                        <input type="submit" class="pr-5"value="Urban Architecture">
                    </form>  
                    <form class="" action="{{route('architect.interior')}}" method="get"> @csrf
                        <input type="hidden" name="interior" value="interior">
                        <input type="submit" style="padding-right:40px" value="Interior Architecture">
                    </form>
                    <form class="" action="{{route('architect.industrial')}}" method="get"> @csrf
                    ...
                    <form class="" action="{{route('architect.residential')}}" method="get"> @csrf
                    ...
                    <form class="" action="{{route('architect.landscape')}}" method="get"> @csrf
                        <input type="hidden" name="landscape" value="landscape">
                        <input type="submit" style="padding-right:15px" value="Landscape Architecture">
                    </form>
                   
                    <form class="" action="{{route('architect.commercial')}}" method="get"> @csrf
                    ...
                    <div class="">
                        <div class="tab-pane active" id="firsttab">
                            <div class="single-sidebar-widget search-widget">
                                <form class="search-form" action="{{route('architect.find')}}" method="get"> @csrf
